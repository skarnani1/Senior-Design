    ...
    <Container component="main" maxWidth="lg" style={{ marginTop: '20px' }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          ...
          <Button variant="contained" color="secondary" onClick={handleDetectArbitrage} style={{ marginLeft: '10px' }}>
            Detect Arbitrage
          </Button>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={3}>
        ...
        {arbitrageResults.length > 0 ? (
          arbitrageResults.map((result, index) => (
            <Box key={index} border={1} borderColor="grey.400" borderRadius={4} padding={2} marginBottom={4}>
